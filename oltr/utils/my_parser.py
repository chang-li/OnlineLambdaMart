...
class SimulationArgumentParser(ArgumentParser):
    ...
    def __init__(self, description=None, set_arguments={}):
        ...
        self.add_argument('-K', '--n_pos', dest='K', default=10, type=int, help='number of positions')
        ...
        self.add_argument('--n_estimator', default=500, type=int, help='number of trees')
        self.add_argument('--leaning_rate', default=0.02, type=float, help='learning rate')
